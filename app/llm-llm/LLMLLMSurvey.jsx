            ...
            {SurveyScenario.map((question, index) => (
                ...
                >
                    ...
                    <button
                        ...
                        disabled={loading[question]} // Disable button while loading
                        className="w-full sm:w-auto px-4 py-2 bg-[#19b394] text-white font-semibold rounded-md hover:bg-[#168a73] transition duration-200 flex items-center justify-center"
                    >
                        {loading[question] ? (
                            <>
                                <svg
